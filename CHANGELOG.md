...
### Fixed
- Added TypeScript exclude pattern for deprecated folder to resolve compilation errors
- Excluded deprecated legacy session files from TypeScript compilation
